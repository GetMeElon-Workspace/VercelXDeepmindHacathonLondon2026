...
export default function ProposalNode({ id, data, isConnectable }: NodeProps<ProposalNodeData>) {
  ...
  return (
    <div className="w-80 rounded-xl border-2 border-dashed border-yellow-600 glass-panel pending-node shadow-[0_0_15px_rgba(202,138,4,0.2)] transition-all hover:scale-[1.02] overflow-hidden text-sm relative node-animate-enter">
      <Handle 
        type="target" 
